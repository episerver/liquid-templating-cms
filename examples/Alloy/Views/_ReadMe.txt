...
* Views for pages and blocks with their own controllers use standard ASP.NET MVC conventions - <controllerName_minus_"controller">/<actionName>.liquid
* Page types which don't have their own controller are mapped to <pageTypeClassName>/Index.liquid by DefaultPageController
