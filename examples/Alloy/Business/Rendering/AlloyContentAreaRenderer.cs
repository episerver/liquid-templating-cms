...
using Optimizely.CMS.Labs.LiquidTemplating.Rendering;
using static Alloy.Liquid.Globals;

namespace Alloy.Liquid.Business.Rendering;

/// <summary>
/// Extends the default <see cref="ContentAreaRenderer"/> to apply custom CSS classes to each <see cref="ContentFragment"/>.
/// </summary>
public class AlloyContentAreaRenderer : LiquidContentAreaRenderer
{
