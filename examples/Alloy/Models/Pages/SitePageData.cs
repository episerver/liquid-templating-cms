...
using Alloy.Liquid.Business.Rendering;
using Alloy.Liquid.Helpers;
...
public abstract class SitePageData : PageData, ICustomCssInContentArea
{
    ...
    public string[] ThemeCssClassNames => CategorizableExtensions.GetThemeCssClassNames(this);

    public bool HasTemplate => PageDataExtensions.HasTemplate(this);
}
